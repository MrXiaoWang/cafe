...
<body>
	<header class="mui-bar mui-bar-nav">
	    ...
	    <h1 class="mui-title">宫保鸡丁</h1>
	</header>
	<div class="mui-content">
		<!--详情图-->
	    <div class="detail-img">
	    	<img src="/cafe/Public/home/img/cai/s9.jpg"/>
	    </div>
	    <div class="mui-content mui-content-padded">
	    	<div class="det-box">
		    	<div class="det-top">
		    		<div class="top-left mui-pull-left">
		    			<span class="det-tit">宫保鸡丁</span>
		    		</div>
		    		<div class="top-right mui-pull-right">
		    			<i>现价：￥</i><span class="det-price">20</span>
		    		</div>
		    	</div>
		    ...
		    <div class="describe">
		    	...
		    	<div class="liao">
		    		...
		    		<p class="liao-content">里脊肉、大葱、花生米、料酒、盐、蛋清、醋、干辣椒、胡椒粉、淀粉、酱油、糖、干辣椒、花椒</p>
		    	</div>
		    	<!--制作方法-->
		    	<div class="make">
