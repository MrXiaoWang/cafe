...
<head>
    ...
    <link rel="stylesheet" href="/cafe/Public/qiantai/css/xiangqing.css" />
    <link rel="stylesheet" href="/cafe/Public/qiantai/css/detail/detail.css" />
    <script type="text/javascript" charset="UTF-8">
      	mui.init();
    </script>
</head>
<body>
<?php if(is_array($caiping)): foreach($caiping as $key=>$a): ?><header class="mui-bar mui-bar-nav">
	    <a class="mui-action-back mui-icon mui-icon-left-nav mui-pull-left"></a>
	    <h1 class="mui-title"><?php echo ($a["minfo_name"]); ?></h1>
	</header>
	<div class="mui-content">
		<!--详情图-->
	    <div class="detail-img">
	    	<img src="/cafe/Uploads/<?php echo ($a["minfo_img"]); ?>"/>
	    </div>
	    <div class="mui-content mui-content-padded">
	    	<div class="det-box">
		    	<div class="det-top">
		    		<div class="top-left mui-pull-left">
		    			<span class="det-tit"><?php echo ($a["minfo_name"]); ?></span>
		    		</div>
		    		<div class="top-right mui-pull-right">
		    			<i>现价：￥</i><span class="det-price"><?php echo ($a["minfo_price"]); ?></span>
		    		</div>
		    	</div>
		    	<div class="det-bottom">
		    		...
		    		<div class="bottom-right mui-pull-right">
		    			<span>原价：</span><s><i>￥</i><span class="det-Oldprice"><?php echo ($a["minfo_original"]); ?></span></s>
		    		</div>
		    	</div>
		    </div>
		    <!--描述-->
		    <div class="describe">
		    	...
		    	<div class="liao">
		    		...
		    		<p class="liao-content"><?php echo ($a["minfo_remark"]); ?></p>
		    	</div>
		    	<!--制作方法-->
		    	<div class="make">
...
胡椒粉，再加一些水，让鸡胸肉吃饱水。
							<div class="box_pic">
								<img src="/cafe/Public/qiantai/img/cai/s1.jpg" />
							</div>
		    			</p>
		    			<p class="step-div">
...
淀粉和蛋清呢？因为蛋清预热会凝固，锁住水分～
							<div class="box_pic">
								<img src="/cafe/Public/qiantai/img/cai/s2.jpg" />
							</div>
		    			</p>
		    			<p class="step-div">
...
点香味再放入鸡胸肉一起炒。
							<div class="box_pic">
								<img src="/cafe/Public/qiantai/img/cai/s3.jpg" />
							</div>
		    			</p>
		    			<p class="step-div">
		    				...
		    				<div class="box_pic">
			    				<img src="/cafe/Public/qiantai/img/cai/s4.jpg" />
							</div>
		    			</p>
		    			<p class="step-div">
		    				...
		    				<div class="box_pic">
			    				<img src="/cafe/Public/qiantai/img/cai/s5.jpg" />
							</div>
		    			</p>
		    			<p class="step-div">
		    				...
		    				放入花生米，翻炒几秒钟就起锅。
		    				<div class="box_pic">
			    				<img src="/cafe/Public/qiantai/img/cai/s6.jpg" />
							</div>
		    			</p>
		    		</div>
		    	</div>
